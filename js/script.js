(function($) {
	...
	if($('.timer').length){
	   ...
	   $('.cs-countdown').countdown('').on('update.countdown', function(event) {
		  var $this = $(this).html(event.strftime('<div class="count-col"><div class="count-text"><span>%D</span><h6>days</h6></div></div> <div class="count-col"><div class="count-text"><span>%H</span><h6>Hours</h6></div></div> <div class="count-col"><div class="count-text"><span>%M</span><h6>Minutes</h6></div></div> <div class="count-col"><div class="count-text"><span>%S</span><h6>Seconds</h6></div></div>'));
		});
	}
